    ...
    try:
        ...
        if opcao == 1:
            try:
                ...
                print("Entrada inválida. Por favor, digite um número válido para o valor em reais.")
            ...
            try:
                ...
                print("Entrada inválida. Por favor, digite um número válido para o valor em dólares.")
